...
const startIndex = content.indexOf('<div id="proposal-report"');
                     ...
                     <div className="flex flex-col space-y-4">
                       {result.phasedScalingStrategy?.map((phase, idx) => (
                          <div key={idx} className="bg-[var(--card-bg)] shadow-card p-4 rounded-xl border border-[var(--border-glow)] flex flex-col md:flex-row md:items-center">
                            <div className="flex-shrink-0 mr-4 mb-2 md:mb-0 w-40 border-r border-[var(--border-glow)]">
...
`;
    ...
    fs.writeFileSync('ProposalGenerator.tsx', newContent);
